...
| Traffic Data           | TomTom Traffic Incident Details API (v5)                    |
...
[Screenshot 1: Local dev server running the base map]
...
`{lat, lng, label, type, metadata}` schema shared across all data sources.*

[Screenshot 3: Traffic layer showing live incidents]
...
[Screenshot 4: Weather alert markers]
...
[Screenshot 5: News layer with filtered local headlines]
...
[Screenshot 6: Custom data layer rendered on the globe]
...
[Screenshot 7: Anansi rebrand — logo and theme]
...
- Add TomTom live traffic *flow* (congestion coloring) alongside incident markers.
